...
accordionItem.forEach(item => {
    var header = item.querySelector(".accordion-ttl") != null ? item.querySelector(".accordion-ttl") : item.querySelector(".sidebar-ttl");
    if (header != null) {
...
function accordionHeight() {
    const side_col03_detail_lists =
        document.querySelectorAll(".side-accor-col03");
